...
//                     vector::VectorDialect, xsmm::XsmmDialect,
...
//     auto res = getOperation()->walk([&](vector::ContractionOp contractOp) {
...
//       if (failed(xsmm::utils::checkAccess(rewriter, contractOp, m, n,
//       kVector,
//                                           batch, inputs,
